  ...
  return (
    <>
      ...
      <div id="projects">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-800 text-white transition-colors duration-300">
          {projects.map((project, index) => (
            <div
              key={index}
              className="border p-4 rounded-lg shadow-lg bg-gray-900 border-transparent"
            >
